...
*** Variables ***
@{Capabilities_Expected}=    Create List    (All Capabilities)    Advanced Analytics    Customer    Due Diligence    	Enterprise Technology    M&A and Divestitures    Org    Performance Improvement    	Strategy    Sustainability & Corporate Responsibility    Transformation & Change
